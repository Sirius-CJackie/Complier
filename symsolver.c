// /*
// what is symbol?
// complier maintain a table to symbol{type, name}
// the function , value and struct all be as the symbol
// we must sure every symbol name is unqiue
// */
// #include <stdlib.h>
// #include "compiler.h"
// //push symbol into vector
...
// }
// //from name get the symbol return struct symbol
...
//     return symbol;
// }
// //this be use get native function symbol from name
// struct symbol* symresolver_get_symbol_for_native_function(struct compile_process* process, const char* name)
// {
//     struct symbol* sym = symresolver_get_symbol(process, name);
//     if (!sym)
//         return NULL;
//     //we must determine this is native fuc type
//     if (sym->type != SYMBOL_TYPE_NATIVE_FUNCTION)
//         return NULL;
//     return sym;
// }
// // register a symbol and push in vector
...
// {
//     compiler_error(process,"em now we cant support the val\n");
// }

// void symresolver_build_for_function_node(struct compile_process* process, struct node* node)
// {
//     compiler_error(process,"em now we cant support the function\n");
// }
...
// {
//     compiler_error(process,"em now we cant support the union\n");
// }
// // build the symbol from node
