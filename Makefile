OBJECTS=./build/compiler.o ./build/cprocess.o  ./build/token.o ./build/parser.o  ./build/node.o ./build/helper.o ./build/datatype.o ./build/fixup.o ./build/scope.o ./build/symsolver.o ./build/expressionable.o   ./build/array.o ./build/helpers/vector.o ./build/helpers/buffer.o ./build/lexer.o ./build/lex_process.o
INCLUDES= -I./
...
./build/symsolver.o: ./symsolver.c
	gcc ./symsolver.c ${INCLUDES}  -o ./build/symsolver.o -g -c
